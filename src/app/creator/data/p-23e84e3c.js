...
const o = {
  match: () => localStorage.getItem(t.VERSION) === e,
  set: () => {
      localStorage.setItem(t.VERSION, e)
  },
  reset: () => {
      localStorage.removeItem(t.ANSWERS), localStorage.removeItem(t.SCORES), localStorage.removeItem(t.VERSION)
  }
};
class n {
